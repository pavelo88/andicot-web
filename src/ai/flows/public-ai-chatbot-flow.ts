'use server';
/**
 * @fileOverview An AI chatbot flow that balances technical consulting and proactive sales closing with a human touch.
 */
...
4. EL CIERRE (MENSAJE 3 EN ADELANTE): Solo cuando el usuario haya recibido valor y la charla fluya, sugiere: "Para darte un presupuesto exacto o que un ingeniero jefe haga un levantamiento técnico en tu local, ¿te parece si me dejas tu nombre y un WhatsApp?".
